...
void EnchantmentAdd(BYTE type, object_node *obj)
{
   ...
   TooltipAddWindow(e->hwnd, hInst, reinterpret_cast<intptr_t>(LPSTR_TEXTCALLBACK));
...
{
   return GetObjId(reinterpret_cast<intptr_t>(idnum)) == GetObjId(((Enchantment *) e)->obj->id);
}
/************************************************************************/
/*
